  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        poppins: ['Poppins-ExtraBold','Poppins-Regular','Poppins-Medium' ,'Poppins-Light' ,'poppins-Black','Poppins-SemiBold', 'Poppins-Bold', 'Poppins-Medium' , 'sans-serif'],
        ...
        chocolate: ['Painting with Chocolate', 'cursive'],
      },
      screens: {
