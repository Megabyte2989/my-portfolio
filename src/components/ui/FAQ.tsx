...
export default function FaqSection({ data }: FaqSectionProps) {
  ...
  return (
    <div className="flex justify-center items-start">
      <div
        className="mx-auto max-w-md rounded-lg bg-transparent p-4"
        style={{ maxWidth: "900px", minWidth: "900px" }} // Adjusted sizes
      >
      ...
      <div className="ml-4">
        <img src="/faq.png" alt="FAQ Image" className="rounded-lg" style={{ maxWidth: "400px" }} />
      </div>
    </div>
  );
}
